 ...
 * The current version is based on the old version v2.1.1
 * The current version is based on [Android-PullToRefresh](https://github.com/chrisbanes/Android-PullToRefresh/)
 * If I have power, please contact me<nangongyibin@gmail.com>
